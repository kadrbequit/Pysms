...
**Bu araç sadece eğitim ve test amaçlıdır. İzinsiz kullanımı yasa dışıdır!**

## ✨ Özellikler

- 📱 **40+ API Desteği**: Türkiye'deki popüler platformlar
- ⚡ **Turbo Mod**: Paralel gönderim ile hızlı SMS
- 🎨 **Renkli Çıktı**: Okunması kolay terminal arayüzü
- 📁 **Dosya Desteği**: Toplu numara gönderimi
- 🔄 **Sonsuz Mod**: Sürekli SMS gönderimi
